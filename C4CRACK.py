...
sprint ("\033[1;33m<========================\033[96m[ \033[1;31m@A4AHIRAN\033[96m ]\033[1;33m=========================>\033[96m")
print ("Telegram - \033[1;31mhttps://t.me/a4ahiran\n\033[96mInstagram - \033[1;31mhttp://instagram.com/saket.yaduvanshi16\n\033[96mOwner - \033[1;31m@A4AHIRAN\n\033[96mManager -\033[1;31m @A4AHIRAN")
print ("\033[1;33m<================================================================>\n\n")
class FaceBoom(object):
    ...
    def login(self, target, password):
        try:
            ...
            print ("\033[1;33m<========================\033[96m[ \033[1;31m@A4AHIRAN\033[96m ]\033[1;33m=========================>\033[96m")
            time.sleep(1.5)
            sys.exit(1)
...
\t[>] Wordlist    :> """ + yl + str(wordlist) + gr + """/t""" + wi)
    ...
    def updateFaceBoom():
        ...
        conn.request("GET", "https://github.com/A4AHIRAN/version.txt")
